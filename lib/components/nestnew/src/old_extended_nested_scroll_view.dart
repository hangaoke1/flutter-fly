...
class _NestedScrollCoordinator
  ...
  void applyUserOffset(double delta) {
    ...
    if (_innerPositions.isEmpty) {
      ...
      // 手指向下，列表向上滚动
      // print('outpostion pixels>>> ${_outerPosition.pixels}');
      // print('outpostion maxScrollExtent >>> ${_outerPosition.maxScrollExtent}');
      // if (_outerPosition.pixels != _outerPosition.maxScrollExtent) {
      //   for(_NestedScrollPosition x in _innerPositions) {
      //     if (x != _currentInnerPositions.first) {
      //       x.localJumpTo(0.0);
      //     }
      //   }
      // }
